...
export class ApiExceptionFilter implements ExceptionFilter {
    ...
    const errorResponse: ApiErrorResponse = {
      ...
      error: {
        ...
        message: isServerError ? 'Internal server error' : this.normalizeMessage(body.message ?? body.error ?? 'Request failed'),
        ...(isServerError ? {} : body.details === undefined ? {} : { details: body.details }),
      },
